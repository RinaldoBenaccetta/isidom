...
-   `query` **[string][87]** 
-   `element` **[HTMLElement][88]**  (optional, default `elements.document`)
...
-   `element` **[HTMLElement][88]**  (optional, default `constant.$document`)
...
-   `query` **[string][87]** 
-   `element` **[element][94]**  (optional, default `elements.$document`)
