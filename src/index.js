...
export * from './lib/manipulators/attributes/get-attribute'
export * from './lib/manipulators/attributes/get-attributes'
export * from './lib/manipulators/attributes/get-data'
export * from './lib/manipulators/attributes/get-style'
export * from './lib/manipulators/attributes/get-text'
export * from './lib/manipulators/attributes/get-value'
export * from './lib/manipulators/attributes/remove-style'
export * from './lib/manipulators/attributes/set-attribute'
export * from './lib/manipulators/attributes/set-style'
export * from './lib/manipulators/attributes/set-text'
export * from './lib/manipulators/attributes/set-value'

export * from './lib/manipulators/classes/add-class'
export * from './lib/manipulators/classes/has-class'
export * from './lib/manipulators/classes/remove-class'
export * from './lib/manipulators/classes/replace-class'
export * from './lib/manipulators/classes/toggle-class'
...
export * from './lib/size/get-height'
export * from './lib/size/get-offset'
export * from './lib/size/get-width'
