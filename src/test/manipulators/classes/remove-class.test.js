...
document.body.innerHTML =
  ...
  '<div class="myFirstClass myFirdClass wantToGoClass">hello</div>\
...
describe('$removeClass', () => {
  describe('given a string and an HTMLElement', () => {
    ...
    test('wich is a valid class, remove the class from the HTMLElement', () => {
    ...
    test('wich is a valid class with dot at start, remove the class from the HTMLElement', () => {
      $removeClass('.wantToGoClass', TARGET_ID)
      expect(TARGET_ID).toHaveClass('killMeClass')
      expect(TARGET_ID).toHaveClass('wantToGoClassBestFriend')
      expect(TARGET_ID).not.toHaveClass('wantToGoClass')
    ...
    test('wich is a valid class with spaces at start and end, remove the class from the HTMLElement', () => {
      $removeClass('   wantToGoClass     ', TARGET_ID)
      expect(TARGET_ID).toHaveClass('killMeClass')
      expect(TARGET_ID).toHaveClass('wantToGoClassBestFriend')
      expect(TARGET_ID).not.toHaveClass('wantToGoClass')
  ...
  describe('given an array of strings and an HTMLElement', () => {
    const TARGET_ID = document.getElementById('myId')
    test('wich is an array of valid classes, remove the class from the HTMLElement', () => {
      $removeClass(
  ...
  describe('given a string and a nodeList', () => {
    ...
    test('wich is a valid class, remove the class from the HTMLElement of the HTMLCollection', () => {
  ...
  describe('given an array of strings and a nodeList', () => {
    const TARGET_ELEMENTS = document.querySelectorAll('.myFirstClass')
    test('wich is a valid class, remove the class from the HTMLElement of the nodeList', () => {
      $removeClass(
        ['wantToGoClass', 'wantToGoClassBestFriend', 'killMeClass'],
        TARGET_ELEMENTS
      )
