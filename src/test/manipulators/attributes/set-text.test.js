import { $setText } from '../../../manipulators/attributes/set-text'
...
const DOC =
  ...
  <div class="myFirstClass">\
    ...
    <div class="myFirdClass mySecondClass" id="mySecondId">Hello world!</div>\
...
describe('$setText', () => {
  describe('given a string and an HTMLElement', () => {
    ...
    test('wich already have text, set a new text for the HTMLElement', () => {
      document.body.innerHTML = DOC
